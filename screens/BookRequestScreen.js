...
export default class BookRequestScreen extends Component{
  ...
  addRequest = async (bookName,reasonToRequest)=>{
    ...
    var books = await BookSearch.searchbook(bookName,'AIzaSyCgo-HUY080nY5ZkjoPZJsB_heY-oN-MYM')
...
componentDidMount(){
  ...
  //  var books = BooksSearch.searchbook(bookName,'AIzaSyCgo-HUY080nY5ZkjoPZJsB_heY-oN-MYM')
  //  console.log(books);   
}
